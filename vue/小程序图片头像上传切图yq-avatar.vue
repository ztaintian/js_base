<template name="yq-avatar">
	<view>
		...
		<canvas canvas-id="oper-canvas" id="oper-canvas"  class="oper-canvas" :style="{top: styleTop, height: cvsStyleHeight}" disable-scroll="true" @error="aa"	 @touchstart="fStart" @touchmove="fMove" @touchend="fEnd"></canvas>
...
/* eslint-disable */
	...
	export default {
		...
		created() {
			this.ctxCanvas = wx.createCanvasContext('avatar-canvas', this);
			this.ctxCanvasOper = wx.createCanvasContext('oper-canvas', this);
			this.ctxCanvasPrv = wx.createCanvasContext('prv-canvas', this);
