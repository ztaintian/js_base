...
export const treeMapEach = (data, { children = 'children', conversion }) => {
  ...
  if (haveChildren) {
      return Object.assign(Object.assign({}, conversionData), { [children]: data[children].map((i) => treeMapEach(i, {
              children,
              conversion
          })) });
  }
...
*/
export const checkSelectedNode = (tree, nodeId, level = 2) => {
...
* @param nodeId 节点 id
*/
export const treeToString = (tree, nodeId) => {
  if (typeof tree === 'undefined' || !Array.isArray(tree) || tree.length === 0) {
      console.warn('tree must be an array');
      return '';
  }
